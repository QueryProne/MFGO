...
export const PERMISSIONS = {
  ...
  "tasks.view": ["admin", "planner", "sales", "buyer", "engineer", "quality", "operator"],
  "tasks.manage": ["admin", "planner", "sales", "buyer", "engineer", "quality"],
  "chat.query": ["admin", "planner", "sales", "buyer", "engineer", "quality", "operator"],
  "leads.view": ["admin", "sales", "planner"],
  "leads.manage": ["admin", "sales"],
  "opportunities.view": ["admin", "sales", "planner"],
  "opportunities.manage": ["admin", "sales"],
  "automation.view": ["admin", "planner", "sales"],
  "automation.manage": ["admin", "planner", "sales"],
