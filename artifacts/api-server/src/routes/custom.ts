...
const STANDARD_APP_PAGES: Array<{
  ...
  { pageId: "planning", title: "Workbench", route: "/planning", description: "Planning and purchasing workbench." },
  ...
  { pageId: "boms", title: "Bills of Material", route: "/boms", description: "BOM management." },
  { pageId: "workcenters", title: "Work Centers", route: "/workcenters", description: "Work center setup and capacity." },
  { pageId: "workorders", title: "Work Orders", route: "/workorders", description: "Production work order execution." },
  { pageId: "serviceorders", title: "Service Orders", route: "/serviceorders", description: "Service order operations." },
  { pageId: "inventory", title: "Inventory", route: "/inventory", description: "Inventory and stock visibility." },
  { pageId: "shipments", title: "Shipping", route: "/shipments", description: "Shipment execution and status." },
  { pageId: "invoices", title: "Invoicing", route: "/invoices", description: "Invoicing and billing operations." },
  { pageId: "quality", title: "Quality", route: "/quality", description: "Quality inspections and controls." },
  { pageId: "copilot", title: "AI Copilot", route: "/copilot", description: "AI copilot workspace." },
  { pageId: "smarttransfer", title: "Smart Transfer", route: "/smarttransfer", description: "Import and transfer tools." },
